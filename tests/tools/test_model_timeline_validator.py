...
class ModelTimelineValidatorTests(unittest.TestCase):
    ...
    def test_policy_regression_fixture_fails_broad_rules(self):
        ...
        self.assertIn("radar-multiclass-timing-source-precedence", rules)
        self.assertIn("radar-multiclass-countdown-source-mismatch", rules)
        self.assertIn("radar-multiclass-countdown-label", rules)
