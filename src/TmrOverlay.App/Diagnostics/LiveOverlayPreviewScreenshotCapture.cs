...
internal static class LiveOverlayPreviewScreenshotCapture
{
        ...
        AppPerformanceState performanceState)
    {
        ...
        var state = new LiveOverlayPreviewScreenshotState(
            ...
            LegacyShowInPracticeSetting: overlaySettings.ShowInPractice,
            LegacyShowInQualifyingSetting: overlaySettings.ShowInQualifying,
            LegacyShowInRaceSetting: overlaySettings.ShowInRace,
        ...
        Exception exception)
    {
        return new LiveOverlayPreviewScreenshotState(
            ...
            ShouldRender: null,
            EnabledSetting: null,
            LegacyShowInPracticeSetting: null,
            LegacyShowInQualifyingSetting: null,
            LegacyShowInRaceSetting: null,
            Scale: null,
            Opacity: null,
            TransparentBackground: request.Spec.UsesTransparentBackdrop,
            ForcedVisibleForDiagnostics: true,
...
internal sealed record LiveOverlayPreviewScreenshotState(
    ...
    bool? ShouldRender,
    bool? EnabledSetting,
    bool? LegacyShowInPracticeSetting,
    bool? LegacyShowInQualifyingSetting,
    bool? LegacyShowInRaceSetting,
    double? Scale,
    double? Opacity,
