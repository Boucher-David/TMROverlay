...
Status: product direction agreed on 2026-07-18. The first remote Bridge release uses a payload-blind, end-to-end protected data plane; it does not ship a relay-visible interim telemetry transport.
